...
type InvertPatternForExcludeInternal<
	p,
	i,
	empty = never,
> = // and it will end up being a false positif if we distribute it. // type is a union of literal as well as a Primitive type // We need to prevent distribution because the boolean
unknown extends p
	? i
	: [p] extends [Primitives]
